...
public class LeaveProfileDTO {
    ...
    public LeaveProfileDTO (Integer id, String name, Float casual, Float medical, Float maternity, Float paternity, Float annual, Float lieu, Float special, Float coverup, Float nopay){
        this.id = id;
        this.name = name;
        this.casual = casual;
